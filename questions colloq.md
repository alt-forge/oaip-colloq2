...
## 10. (Сколько указателей!) Динамические структуры данных: стек, очередь, кольцо. Организация, принцип использования.
...
В C++ не используется, так как дефис воспринимается как минус.
